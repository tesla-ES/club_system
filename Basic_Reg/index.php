<!DOCTYPE html>
<!-- saved from url=(0062)http://www.webstrot.com/html/myporto/light_version/index.html# -->
...
<body class="clearfix">
    ...
    <div class="fixed-left-side-body">
        <div class="profile">
            <div class="profile-image center-align">
                <img src="../new_reg/index-gradient_files/akshay2.png" alt="Image">
            </div>
            <!-- /.profile-image -->
            ...
            <!-- /.discription -->
            <div class="cv-btn">
                <a href="index.html#!" class="custom-btn waves-effect waves-light">
    ...
    <div class="right-side-body">
        ...
        <header id="header-section" class="header-section mb-30 clearfix">
                    ...
                    <div class="nav-wrapper main-nav-wrapper">
                        ...
                        <ul class="alternative-menu ul-li responsive_menu_fixed">
                            ...
                            <li class="side-menu-btn right">
                                <a href="index.html#" class="button-collapse waves-effect default" data-activates="mobile-demo">
                        ...
                        <div class=" hello_icon_menu hello_single_index_menu1">
                            <ul class="ul-li-block side-nav" id="mobile-demo" style="transform: translateX(-100%);">
								...
								<img src="../new_reg/index-gradient_files/akshay1.png" alt="Image">
							</span>
                                    <span class="sn-user-name">
								Akshay
							</span>
                                    <a href="index.html#" class="sn-cv-link common-color">download cv</a>
                                </li>
                                <!-- /.sn-user -->
                        ...
                        <div class="hello_main_navigation hello_single_index_menu2">
                            <ul id="nav-mobile" class="right main-nav-ul">
                                ...
                                <li><a href="6" class="waves-effect default">exprience</a></li>
                                <li><a href="7" class="waves-effect default">blog</a></li>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="hello_logo_wrapper">
                                        <div class="hello_logo">
                                            <img src="../new_reg/index-gradient_files/logo.png" alt="hello_logo">
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="cd-search" class="cd-search">
                <form action="Basic_Reg_Search_fun.php">
        ...
        <section id="main-slider-section" class="main-slider-section mb-30 clearfix">
            ...
            <div class="owl-stage-outer">
             <div class="owl-stage" style="transform: translate3d(-3567px, 0px, 0px); transition: all 0s ease 0s; width: 6243px;">
                <div class="owl-item cloned" style="width: 891.75px;">
                    <div class="item">
                       <div class="row">
                        ...
                        <div class="col l6 m6">
                            <div class="item-child-right right-align">
                                <img src="../new_reg/index-gradient_files/akshay1.png" alt="Image">
                                <a href="index.html#" class="chat waves-effect waves-light">
                ...
                <div class="owl-item" style="width: 891.75px;">
                    <div class="item">
                     <div class="row">
                ...
                <div class="owl-nav disabled"><div class="owl-prev">prev</div><div class="owl-next">next</div></div><div class="owl-dots"><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot active"><span></span></div></div></div>
            <!-- /.main-slider -->
        ...
        <div data-scroll="1" class="aboutme-section sec-p100-bg-bs mb-30 clearfix" id="about">
                        ...
                        <div class="personal-details-left">
                            <ul class="service-list ul-li">
                                <li class="logodesign">
                                    ...
                                    <a href="index.html#" class="more"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                </li>
                                <li class="website">
            ...
            <div class="success">
                ...
                <div class="success-child-right">
                    <a href="index.html#!" class="hire-me waves-effect">
        ...
        <div data-scroll="2" class="my-skill-section sec-p100-bg-bs mb-30 clearfix" id="skill">
            ...
            <div class="professional-skills-area">
                <ul class="tabs skills-tab ul-li">
                    ...
                    <li class="tab tag-item"><a href="index.html#">#graphicdesign</a></li>
                    <li class="tab tag-item"><a href="index.html#" class="active">#photography</a></li>
                    <li class="tab tag-item"><a href="index.html#">#technology</a></li>
                    <li class="tab tag-item"><a href="index.html#">#design</a></li>
                    <li class="tab tag-item"><a href="index.html#">#webdevelopment</a></li>
                    <li class="tab tag-item"><a href="index.html#">#application</a></li>
                <div class="indicator" style="right: 508.922px; left: 161.359px;"></div></ul>
                ...
                <div class="row">
                    ...
                    <div class="col l6 m12 s12">
                        <div class="lang-skill-left">
                            ...
                            <a href="index.html#" class="common-color">https://www.youtube.com</a>
                        </div>
                        <!-- /.lang-skill-left -->
                    </div>
                    <!-- colm6 -->
                    <div class="col l6 m12 s12">
                        <div class="lang-skill-right">
                            <div class="skill-piechart">
                                <div class="first circle"><canvas width="120" height="120"></canvas>
                                    <strong>HINDI</strong>
                                </div>
                            </div>
                            <!-- /pie-chart -->
                            ...
                            <div class="skill-piechart">
                                <div class="second circle"><canvas width="120" height="120"></canvas>
                                    <strong>ENGLISH</strong>
                                </div>
                            </div>
                            <!-- /pie-chart -->
                            <div class="skill-piechart">
                                <div class="third circle"><canvas width="120" height="120"></canvas>
                                    <strong>DUTCH</strong>
                                </div>
                            </div>
                            <!-- /pie-chart -->
        ...
        <div data-scroll="3" class="education-section sec-p100-bg-bs mb-30 clearfix" id="education">
            ...
            <ul class="accordion collapsible" data-collapsible="accordion">
                ...
                <li class="">
                    <div class="accordion-header acco-clr2 collapsible-header">
                        <span class="icon">
							<i class="fa fa-pencil" aria-hidden="true"></i>
						</span>
                        <p>
                ...
                <li class="">
                    <div class="accordion-header acco-clr3 collapsible-header">
                        <span class="icon">
							<i class="fa fa-pencil" aria-hidden="true"></i>
						</span>
                        <p>
                ...
                <li class="">
                    <div class="accordion-header acco-clr4 collapsible-header">
                        <span class="icon">
							<i class="fa fa-pencil" aria-hidden="true"></i>
						</span>
                        <p>
                ...
                <li class="">
                    <div class="accordion-header acco-clr5 collapsible-header">
                        <span class="icon">
							<i class="fa fa-pencil" aria-hidden="true"></i>
						</span>
                        <p>
                    ...
                    <div class="accordion-body collapsible-body" style="display: none; padding-top: 50px; margin-top: 0px; padding-bottom: 50px; margin-bottom: 0px;">
                        <span>
							Successfully passed MBA’ on year 2015 - 2016 scoring CGPA 4.00 out of 4.00. The study fields were Cpmputer Architecture, Calculus, Physics Fundamental of Physics, Chemistry, Integral Mathematics. ABC University of los Angeles.
						</span>
                    </div>
            ...
            <div class="portfolio-area">
                ...
                <div class="grid" style="position: relative; height: 560px;">
                    <div class="element-item transition metal" data-category="transition" style="position: absolute; left: 0px; top: 0px;">
                        <div class="ei-child">
                            <img src="../new_reg/index-gradient_files/img-1.jpg" alt="Image">
                            <a href="index.html#" class="more">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="element-item metalloid" data-category="metalloid" style="position: absolute; left: 263px; top: 0px;">
                        <div class="ei-child">
                            <img src="../new_reg/index-gradient_files/img-2.jpg" alt="Image">
                            <a href="index.html#" class="more">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="element-item post-transition metal" data-category="post-transition" style="position: absolute; left: 527px; top: 0px;">
                        <div class="ei-child">
                            <img src="../new_reg/index-gradient_files/img-3.jpg" alt="Image">
                            <a href="index.html#" class="more">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="element-item post-transition metal" data-category="post-transition" style="position: absolute; left: 0px; top: 280px;">
                        <div class="ei-child">
                            <img src="../new_reg/index-gradient_files/img-4.jpg" alt="Image">
                            <a href="index.html#" class="more">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="element-item transition metal" data-category="transition" style="position: absolute; left: 263px; top: 280px;">
                        <div class="ei-child">
                            <img src="../new_reg/index-gradient_files/img-5.jpg" alt="Image">
                            <a href="index.html#" class="more">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="element-item alkali metal" data-category="alkali" style="position: absolute; left: 527px; top: 280px;">
                        <div class="ei-child">
                            <img src="../new_reg/index-gradient_files/img-6.jpg" alt="Image">
                            <a href="index.html#" class="more">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                            </a>
                        </div>
        ...
        <div data-scroll="5" class="testomonials-section sec-p100-bg-bs mb-30 clearfix" id="testimonial">
            ...
            <div class="hello_testi_slider_wrapper">
                <div id="testomonial-carousel" class="owl-carousel owl-theme owl-loaded owl-drag">
                    ...
                    <!-- /.item -->
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2465px, 0px, 0px); transition: all 0s ease 0s; width: 9040px;"><div class="owl-item cloned" style="width: 791.75px; margin-right: 30px;"><div class="item">
                        <div class="testomonial-img">
                            <img src="../new_reg/index-gradient_files/testomonial-img3.jpg" alt="Image">
                        </div>
                        <!-- /.testomonial-img -->
                        ...
                        <div class="testomonial-contant">
                            ...
                            <a href="index.html#" class="common-color">https:example.com</a>
                        </div>
                        <!-- /.testomonial-contant -->
                    </div></div><div class="owl-item cloned" style="width: 791.75px; margin-right: 30px;"><div class="item">
                        <div class="testomonial-img">
                            <img src="../new_reg/index-gradient_files/testomonial-img4.jpg" alt="Image">
                        </div>
                        <!-- /.testomonial-img -->
                        ...
                        <div class="testomonial-img">
                            <img src="../new_reg/index-gradient_files/testomonial-img5.jpg" alt="Image">
                        </div>
                        <!-- /.testomonial-img -->
                        ...
                        <!-- /.testomonial-contant -->
                    </div></div><div class="owl-item active" style="width: 791.75px; margin-right: 30px;"><div class="item">

                        <div class="testomonial-img">
                            <img src="../new_reg/index-gradient_files/testomonial-img1.jpg" alt="Image">
                        </div>
                        <!-- /.testomonial-img -->
                        ...
                        <!-- /.testomonial-contant -->
                    </div></div><div class="owl-item" style="width: 791.75px; margin-right: 30px;"><div class="item">
                        <div class="testomonial-img">
                            <img src="../new_reg/index-gradient_files/testomonial-img2.jpg" alt="Image">
                        </div>
                        <!-- /.testomonial-img -->
                        ...
                        <!-- /.testomonial-contant -->
                    </div></div></div></div><div class="owl-nav"><div class="owl-prev">prev</div><div class="owl-next">next</div></div><div class="owl-dots"><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div></div></div>
            </div>
            ...
            <ul class="brand-list ul-li">
                <li>
                    <a href="index.html#!">
                        <img src="../new_reg/index-gradient_files/brand1.png" alt="Brand Image">
                    </a>
                </li>
                <li>
                    <a href="index.html#!">
                        <img src="../new_reg/index-gradient_files/brand2.png" alt="Brand Image">
                    </a>
                </li>
                <li>
                    <a href="index.html#!">
                        <img src="../new_reg/index-gradient_files/brand3.png" alt="Brand Image">
                    </a>
                </li>
                <li>
                    <a href="index.html#!">
                        <img src="../new_reg/index-gradient_files/brand4.png" alt="Brand Image">
                    </a>
                </li>
                <li>
                    <a href="index.html#!">
                        <img src="../new_reg/index-gradient_files/brand5.png" alt="Brand Image">
                    </a>
                </li>
            </ul>
                        ...
                        <div class="experience-left-item-area">
                            <div class="border-left">
                                ...
                                <div class="experience-item exp1">
                                    ...
                                    <a href="index.html#" class="photoshop-color">https:example.com</a>
                                </div>
                                <!-- /.experience-item -->
                                ...
                                <div class="experience-item exp2">
                                    ...
                                    <a href="index.html#" class="jquery-color">https:example.com</a>
                                </div>
                                <!-- /.experience-item -->
                                ...
                                <div class="experience-item exp3">
                                    ...
                                    <a href="index.html#" class="php-color">https:example.com</a>
                                </div>
                                <!-- /.experience-item -->
        ...
        <div data-scroll="7" class="latest-news-section sec-p100-bg-bs mb-30 clearfix" id="blog">
            ...
            <div class="news-item clearfix">
                <div class="news-image b4-1 left">
                    <img src="../new_reg/index-gradient_files/news1.jpg" alt="Image">
                </div>
                <!-- /.news-image -->
                <div class="news-contant right left-align">
                    <h2 class="title">Creative Deisng News</h2>
                    <ul class="post-mate2">
                        <li class="pm-r25">By <a href="index.html#">akshay</a></li>
            ...
            <div class="news-item clearfix">
                <div class="news-image b4-2 right">
                    <img src="../new_reg/index-gradient_files/news2.jpg" alt="Image">
                </div>
                <!-- /.news-image -->
            ...
            <div class="news-item clearfix">
                <div class="news-image b4-1 left">
                    <img src="../new_reg/index-gradient_files/news3.jpg" alt="Image">
                </div>
                <!-- /.news-image -->
                <div class="news-contant right left-align">
                    <h2 class="title">Creative Deisng News</h2>
            ...
            <ul class="pagination clearfix">
                <li class="left-arrow waves-effect left">
                    <a href="index.html#!"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a>
                </li>

                <li class="waves-effect"><a href="index.html#!">01</a></li>
                <li class="active"><a href="index.html#!">02</a></li>
                <li class="waves-effect"><a href="index.html#!">03</a></li>

                <li class="right-arrow waves-effect right">
                    <a href="index.html#!"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                </li>
            </ul>
                    ...
                    <div class="contact-left">
                        ...
                        <div class="cont-item address">
                            ...
                            <div class="cont-numbers">
                                ...
                                <p><a href="index.html#" class="photoshop-color">https:example.com</a></p>
                            </div>
                            <!-- /.cont-numbers -->
                        </div>
                        <!-- /.cont-item -->
        ...
        <footer id="footer-section" class="footer-section clearfix">
            <p>© 20018 Copyright <a href="index.html#" class="photoshop-color">My Porto</a> Design by <a href="http://webstrot.com/" class="photoshop-color">webstrot.</a></p>
    ...
    <!-- my custom js -->
    <script src="../JS/custom.js"></script><div class="drag-target" data-sidenav="mobile-demo" style="left: 0px; touch-action: pan-y; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></div>
