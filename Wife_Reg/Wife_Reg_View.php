...
<tbody>
<TR  align='right' >
<TD><FONT size='4'  >رقم العضو : <INPUT TYPE='TEXT' NAME='Text1'style='font-size: 10pt; height:25px;width:100px' value='$pop0'  READONLY>
</TD>
...
<TR  >
<TD ><FONT size='4'  > مسلسل  : <INPUT TYPE='TEXT' NAME='Text4' style='font-size: 10pt; height:25px;width:100px' value='$pop3' READONLY></TD>
</TR>
</Tbody>
	</table>
	...
	<TR  align='right'>
<TD><FONT size='4'  > الإسم  : <INPUT TYPE='TEXT' NAME='Text6' id='Text6' style='font-size: 10pt; height:25px;width:200px' value='$pop5' maxlength='$max_length' size='$max_length' onkeyup=textCounter(this,'counter',$max_length)><input type='text' class='counter' readonly size='2' maxlength='2' id='counter' value='$max_length'></TD>
<TD><FONT size='4'  > الإسم فى الكارنيه  : <INPUT TYPE='TEXT' NAME='Text7' style='font-size: 10pt; height:25px;width:200px' value='$pop6'></TD>
...
<TD><FONT size='4'  > جهة العمل  : <INPUT TYPE='TEXT' NAME='Text15' style='font-size: 10pt; height:25px;width:200px' value='$pop14'></TD>
					<TD><FONT size='4'  > يصدر / لايصدر له كارنيه   : 
...
<TH   align=center background='../img/sperator.gif'><A href='#' onclick='(go_page($pop0,$pop1,$pop2,$pop3,$employee))' ><img src='../img/delete.png' border='0' width='26' height='26'><br clear='all'> حذف </A></TH>
