...
<TD ><FONT size='4'  > مسلسل  : <INPUT TYPE='TEXT' NAME='Text4' style='font-size: 10pt; padding-top:5px;height:25px;width:100px' value='$pop3' READONLY></TD>
	...
	<TR  align='right'>
<TD><FONT size='4'  > الإسم  : <INPUT TYPE='TEXT' NAME='Text6'  id='Text6' style='font-size: 10pt; height:25px;width:200px' value ='$pop5' maxlength='$max_length' size='$max_length' onkeyup=textCounter(this,'counter',$max_length)><input type='text' readonly size='2' maxlength='2' id='counter' value='$max_length'></TD>
