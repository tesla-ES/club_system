...
$num_rows=1;
	...
	if($j<3){
	  ...
	  echo "<td ALIGN=RIGHT  > <FONT color='#FFFFFF'><a href='Secondary_Reg_View.php?user_id=$rows[0]&type=$rows[3]&ser=$rows[2]&employee=$rows[4]'> $rows[$j]</td>";
	...
	$j++;
      ...
      echo "</table>";
      writePage_pagination($start,$record_count,$per_page,"Secondary_Reg_List.php","");
