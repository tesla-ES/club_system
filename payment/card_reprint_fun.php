...
if(!empty($User_ID)){
    $sql="update printer_log set reprint_user = $session_user , print= 0 , notes= '".$notes."' where id = $User_ID and type=$reg_type_code and year = $Pay_Year and receipt_no = $Receipt_No ";
