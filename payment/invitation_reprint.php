...
<FORM NAME="FORM1"  action="invitation_reprint_fun.php" method="post" enctype="multipart/form-data">
	<br>
		...
		<table BORDER=1 cellspacing=1 cellpadding=8 >
			...
			<tr>
				<td colspan="2" style="text-align: center">
					<INPUT type='submit' name='b3' id="image-button" value="تنشيط طباع كارت الدعوات مره اخرى ">
